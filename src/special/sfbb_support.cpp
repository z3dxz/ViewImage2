    ...
    *ptr_ = imgwidth;
    ...
    for (int y = 0; y < imgheight; y++) {
        for (int x = 0; x < imgwidth; x++) {
            INT8 pix = (*GetMemoryLocationK(imgdata, x, y, imgwidth));
            *ptr = pix;
            ptr++;
        }
    }
    ...
    for (int y = 0; y < imgheight; y++) {
        for (int x = 0; x < imgwidth; x++) {
            INT8 pix = (*GetMemoryLocationK(imgdata, x, y, imgwidth)) >> 8;
            *ptr = pix;
            ptr++;
        }
    }
    ...
    for (int y = 0; y < imgheight; y++) {
        for (int x = 0; x < imgwidth; x++) {
            INT8 pix = (*GetMemoryLocationK(imgdata, x, y, imgwidth)) >> 16;
            *ptr = pix;
            ptr++;
        }
    }
    ...
    for (int y = 0; y < imgheight; y++) {
        for (int x = 0; x < imgwidth; x++) {
            INT8 pix = (*GetMemoryLocationK(imgdata, x, y, imgwidth)) >> 24;
            *ptr = pix;
            ptr++;
        }
    }
